...
export default function protein() {
  return (
    <>
    <div className={`d-flex ${window.innerWidth <= 900 ?"flex-column":"flex-row flex-wrap"} bg-warning w-100 bg-black h-100`} style={{height:window.innerWidth <= 900 ? "1550px":"1200px",objectFit:"cover"}}>
        <div style={{height:window.innerWidth <= 700 ?"450px":window.innerWidth > 700 && window.innerWidth <= 900 ?"450px":"850px",width:window.innerWidth <= 700 ?"100%":window.innerWidth > 700 && window.innerWidth <= 900 ?"80%":"40%", margin :window.innerWidth <= 700 ?"100px 0px 0px 0px":window.innerWidth > 700 && window.innerWidth  <=900 ?"50px 0px 0px 50px":"150px 0px 150px 0px",padding:window.innerWidth <= 700 ?"15% 15% 10% 15%":window.innerWidth > 700 && window.innerWidth <= 900 ?"15% 5% 10% 5%":"0px 0px 0px 100px"}}>
        ...
        <div className="d-flex flex-column"  style={{height:window.innerWidth <= 700 ?"850px":window.innerWidth > 700 && window.innerWidth <= 900 ?"700px":"850px",width:window.innerWidth <= 900 ?"100%":"60%",margin:window.innerWidth <= 900 ?"10px 0px 10px 0px":"150px 0px 150px 0px",padding:window.innerWidth <= 900 ?"0px":'0px 0px 0px 80px'}}>
            ...
            <p className="text-white mt-2 d-none d-lg-block">___________________________________________________________________________________________</p>
             ...
             <div className={`${window.innerWidth <= 900 ?"ms-3 pt-0 mt-0":""}`}>
