...
const boxes =[
 ...
 <div className="images">
  <div className="d-flex position-relative w-100 bg-dark" style={{ height:window.innerWidth <= 576 ?"500px":"700px",marginTop: window.innerWidth <= 550 ?"0px":"0px",overflow:"hidden"}}>
