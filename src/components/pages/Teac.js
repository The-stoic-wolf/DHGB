...
export default function Teac() {
  return (
    <>
      <div className={` d-flex ${window.innerWidth  <= 900 ? "flex-column":"flex-row"} bg-black`} style={{height:window.innerWidth <= 900 ?"1100px":"850px",width:"100%"}}>
         <div className="d-flex " style={{height:window.innerWidth <= 900 ?"500px":"900px",width:window.innerWidth <= 900 ?"90%":"40%",margin:window.innerWidth <= 750 ?"20% 10% 0% 10%":window.innerWidth > 750 && window.innerWidth > 750 ?"10% 15% 0% 15%":"80px 0px 0px 80px"}}>
           <img src="teac.png" alt="T-logo" style={{height:"450px",width:"90%",padding:window.innerWidth <= 750 ?"10% 5% 5% 5%":window.innerWidth > 750 && window.innerWidth > 750 ?"10% 15% 0% 0%":"10% 5% 5% 5%",objectFit:"cover"}}/>
         </div>

         <div className="d-flex flex-column" style={{height:window.innerWidth <= 900 ?"600px":"900px",width:window.innerWidth <= 900 ?"100%":"40%",margin:window.innerWidth <= 900 ?"20px 50px 10px 10px":"80px 80px 0px 100px"}}>
            <div className={`d-flex ${window.innerWidth <= 900 ?"ps-2 mt-2":"mx-3 mt-4"} flex-column text-white  `}>
              <p className={`${window.innerWidth <= 900 ?"fw-bold fs-4":"fs-3 fw-bold"}`}>VIETNAMESE TEA CEREMONY (ĐÁM HỎI)</p>
            </div>
            <p className={` ${window.innerWidth <= 900 ?"ps-1":"mx-3"} text-white`}>_______________________________________________________________________</p>
            <p className={`${window.innerWidth <= 900 ?"ps-2 fs-6 fst-italic ":"mx-3 fs-5 "}  fw-semibold text-white`}>A Vietnamese tea ceremony, commonly known as ‘Đám Hỏi’, is a profound blend of tradition and symbolism, celebrating not only the union of two souls but also the coming together of two families.</p>

             <p className={` ${window.innerWidth <= 900 ?"ps-2 fs-6 fst-italic ":"mx-3 fs-5 "} fw-semibold text-white `}>Vietnamese Tea Ceremony Rental Policy: A $200 deposit is required to secure your Vietnamese tea ceremony rentals. This deposit will be returned in full once all rental items are returned within 48 hours of the event. If any item is not returned within that timeframe, the corresponding deposit will be forfeited. By renting our Vietnamese tea ceremony items, you agree to these terms.</p>
             <p className={`${window.innerWidth <= 900 ?"ps-1":"mx-3"} text-white`}>_______________________________________________________________________</p>
             <div className="" style={{height:window.innerWidth <= 900 ?"80px":"100px"}}>
...
{/* ----------------------------------------------------------section no 1---------------------------------------------------------------- */}
      <div className={`${window.innerWidth <= 900 ? "pt-3":"pt-5"}`} style={{height:window.innerWidth <= 900 ?"1320px":"1400px",width:"100%",backgroundColor:"rgb(40, 51, 65)"}}> 
        ...
        <div className={`d-flex flex-column ${window.innerWidth <= 900 ?"pt-0":"pt-3"} text-white align-items-center `} style={{height:window.innerWidth <= 900 ?"1300px":"1200px", margin:window.innerWidth <= 900 ?"0px 20px 20px 10px":"0px 300px 50px 300px"}}>
          ...
          <div className="d-flex flex-column mt-4"  style={{height:window.innerWidth <= 900 ?"1100px":"1100px",width:"100%"}}>

            <div className={`d-flex ${window.innerWidth <= 900 ?"flex-column ":"flex-row"} mt-2`} style={{height:window.innerWidth <= 900 ?"180px":"80px"}}>
  ...
  {/* --------------------------------------------------------section no 3--------------------------------------------------------- */}
            <div className="ms-2 mt-1" style={{height:"30px"}}>
            ...
            <div className="d-flex flex-column pt-2 mx-1" style={{width:"98%",height:"200px",border:"3px solid navy"}}>
