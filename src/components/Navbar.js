...
export default function Navbar() {
  ...
  return (
    <div>
          <nav className={`navbar navbar-expand-lg ${style ? "bg-dark bg-opacity-75" : "bg-transparent", window.innerWidth <= 992 ? "bg-dark bg-opacity-75" :"bg-transparent"} fixed-top `}>
  <div className="container-fluid"> 
    <div className="logo1 ">
      <a href="/">
       <img className="ms-2" src={`${window.innerWidth <= 576 ?"cooking-57.png":"cooking-logo.png"}`} alt="logo" />
       </a>
    </div>
